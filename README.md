...
A transparency-first web interface for the **Database of AI Litigation (DAIL)** — designed for policymakers, researchers, and the public. Built on top of two Excel exports from the DAIL project at George Washington University.
